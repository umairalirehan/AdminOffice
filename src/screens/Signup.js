            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <View style={styles.fullPage}>
                    ...
                    <View style={styles.secondView}>
                        <TextInput placeholder="Fullname" placeholderTextColor="silver" returnKeyType="next" style={styles.inputTextFields} />
                        ...
                        <TouchableOpacity style={styles.loginTouchable}>
                            <Text style={styles.loginTouchableText}>SignUp</Text>
                        </TouchableOpacity>
                    ...
                    <View style={styles.thirdView}>
                        ...
                        <View style={{ flex: 1, flexDirection: "row", marginVertical: metrics.smallMargin }}>
                            ...
                            <View style={{ flex: 0.9, backgroundColor: "#4471AD", justifyContent: "center" }}>
                                <TouchableOpacity>
                                    <Text style={styles.facebookLoginTouchability}>Sign Up with Facebook</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        ...
                        <View style={{ flex: 1, flexDirection: "row", borderWidth: 1, borderColor: "silver" }}>
                            ...
                            <View style={{ flex: 0.9, justifyContent: "center" }}>
                                <TouchableOpacity>
                                    <Text style={styles.googleLoginTouchability}>Sign Up with Google</Text>
                                </TouchableOpacity>
                            </View>
                    ...
                    <View style={styles.fourthView}>
                        ...
                        <Text style={{ color: "silver", fontSize: fonts.size.font_14 }}><Text>Already have an account? </Text>
                            <Text style={{ color: "#457ef8", fontWeight: "bold", fontSize: fonts.size.font_14 }} onPress={() => this.props.navigation.navigate('LogIn')}>Log in</Text></Text>
                    </View>
